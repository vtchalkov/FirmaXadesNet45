...
namespace Microsoft.Xades
{
	...
	public class DigestAlgAndValueType
	{
		...
		public void LoadXml(System.Xml.XmlElement xmlElement)
		{
            ...
            {
                throw new CryptographicException("DigestMethod element is missing");
            }
            this.digestMethod = new DigestMethod();
            ...
            if (xmlNodeList.Count == 0)
            {
                throw new CryptographicException("DigestValue element is missing");
            }
		...
		public XmlElement GetXml()
		{
			...
			{
				throw new CryptographicException("DigestMethod element is missing in DigestAlgAndValueType");
			}
			...
			{
				throw new CryptographicException("DigestValue element is missing in DigestAlgAndValueType");
			}
